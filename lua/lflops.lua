...
local function get_groups()
  ...
  local groups = {
    ...
    FloatBorder = config.transparent_mode and { fg = colors.orange, bg = nil } or { fg = colors.orange, bg = colors.bg1 },
    ...
    WinSeparator = config.transparent_mode and { fg = colors.neutral_purple, bg = nil } or { fg = colors.neutral_purple, bg = colors.bg0 },
    ...
    FoldColumn = config.transparent_mode and { fg = colors.dark_blue, bg = nil } or { fg = colors.dark_blue, bg = colors.bg1 },
